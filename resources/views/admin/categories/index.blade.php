                    ...
                    <div class="panel-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="col-sm-6">
                                                ...
                                                <button class="btn btn-success btn-edit" data-toggle="modal" data-target="#editCateModal"
                                                        id="{{ $cate['id'] }}" url="{{route('categories.update', $cate['id'])}}" name="{{ $cate['name'] }}">编辑
                                                </button>
                                            </div>
                                        {{--<a class="btn btn-danger" name="{{ route('categories.destroy', $cate['id']) }}">删除</a>--}}
                                            <form class="col-sm-6 form-only-button" method="POST" action="{{ route('categories.destroy', $cate['id']) }}">
                                                {{--更改隐身提交方法为DELETE--}}
                        ...
                        <form class="form" method="POST" action="{{ route('categories.store') }}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-10">
                                        <input type="text" name="cateName" class="form-control" placeholder="目录名称">
                                    </div>
                                    <div class="col-md-2">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form class="form" method="POST" id="editForm">
                                            ...
                                            <div class="form-group">
                                                <label id="cate-id" class="control-label">
                                                    目录名称
                                                </label>
                                            </div>
                                            <div class="form-group">
                                                <input id="editCateInput" type="text" class="form-control" name="cateName" placeholder="目录名称">
                                            </div>
